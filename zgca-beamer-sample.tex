...
\newcommand{\hrefcol}[2]{\textcolor{zgcayellow}{\href{#1}{#2}}}
...
本模板基于 \hrefcol{https://github.com/wzl-plasmid/ucas-beamer}{UCAS Beamer} 及 \hrefcol{https://www.overleaf.com/latex/templates/sintef-presentation/jhbhdffczpnx}{SINTEF Presentation} 衍生修改，专门适配了中关村学院的视觉标识（主题色：\texttt{\#0363c9}）。
...
\begin{tabular}{lccc}
\hline
\textbf{指标} & \textbf{传统 PPT} & \textbf{UCAS Beamer} & \textbf{ZGCA Beamer (本模板)} \\
\hline
数学公式美观度 & 一般 & 极佳 & \textbf{极佳} \\
视觉色彩一致性 & 难保持 & 较好 & \textbf{优秀 (适配 \#0363c9)} \\
排版自动控制 & 手动调整 & 自动排版 & \textbf{自动排版} \\
学院视觉契合度 & 低 & 较低 & \textbf{高度适配} \\
\hline
\end{tabular}
\caption{演示文稿排版工具及模板对比}
\end{table}
